...
>
  <div class="mx-auto max-w-[1120px]">
   ...
   <p
      ...
      >
        Клінера шукають на дошках, у клінінгових компаніях або питають
        знайомих. Ось що дає кожен зі способів. 
      </p>
    </header>

  <!-- tabindex тут потрібен, щоб таблицю можна було прогорнути
         з клавіатури. Щоб це не було порушенням a11y, регіон має
         власне ім'я (aria-label), а не посилання на заголовок секції. -->
    <div
